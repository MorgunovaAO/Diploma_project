...
Проверка осуществляется путем тестирования функциональностей, работа которых могла быть затронута починкой. Тестирование, последовательно исполняемое в пунктах а) и б), также называется **регрессионным тестированием** (regression testing). 
