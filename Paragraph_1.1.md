...
Чтобы браузер понимал, как отображать текст, используются теги. **HTML тег** — это специальный код (метка, команда), который указывает браузеру, как интерпретировать документ для пользователя.  
